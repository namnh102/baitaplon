...
def get_best_team(df, columns_to_analyze):
    ...
    print("Đội có tần suất cao nhất ở chỉ số là: " + str(frequency_table[0][0]) + " với số lần là: " + str(
        frequency_table[0][1]))
